"""Voto NOMINAL por candidato e secao, para cargo proporcional (dep. federal).
...
Uso:  .venv/Scripts/python -m pipeline.baseline_candidato [2022]
"""
...
def compila(ano: int) -> Path:
    ...
    for i, uf in enumerate(UFS, 1):
        ...
        with z.open(nome) as fh:
            ...
            for r in rd:
                if r["DS_CARGO"].upper() != "DEPUTADO FEDERAL" or r["NR_TURNO"] != "1":
                    continue
    ...
    destino = SAIDA / f"depfederal_candidato_secao_{ano}_t1.parquet"
